...
var mongo_uri = "mongodb+srv://admin:1234@educatespacetopic.vptnm.gcp.mongodb.net/EDUCATE-SPACE?retryWrites=true&w=majority";
...
var Topic = require("./topicrouter");
app.use("/api/topic", Topic);

var Member = require("./memberrouter");
app.use("/api/member", Member);

var Session = require("./sessionrouter");
app.use("/api/session", Session);

var Select = require("./selecttopicrouter");
